...
typedef struct {
  ...
  TFLMigrationType quantized_bias_type;
} TfLiteConvParams;
...
typedef struct {
  TFLMigrationType in_data_type;
  TFLMigrationType out_data_type;
} TfLiteCastParams;
...
typedef struct {
  TFLMigrationType index_out_type;
} TfLiteUniqueParams;
...
typedef struct {
  int table_id;
  TFLMigrationType key_dtype;
  TFLMigrationType value_dtype;
