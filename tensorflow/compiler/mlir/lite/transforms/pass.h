...
struct MutableOptionsPass {
  virtual ~MutableOptionsPass() = default;
  virtual void SetOptions(const PassOptionsSetter &visitor) = 0;
};
...
class Pass : public PassWrapper<Pass<DerivedPass, DerivedPassOptions, OpType>,
 ...
 public:
  ...
  // SetOptions method to `accept` the visitor
  void SetOptions(const PassOptionsSetter &visitor) override {
