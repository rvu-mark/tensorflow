...
/// structures in C++.
#ifndef TENSORFLOW_COMPILER_MLIR_LITE_CONTEXT_UTIL_H_
#define TENSORFLOW_COMPILER_MLIR_LITE_CONTEXT_UTIL_H_
...
#endif  // TENSORFLOW_COMPILER_MLIR_LITE_CONTEXT_UTIL_H_
