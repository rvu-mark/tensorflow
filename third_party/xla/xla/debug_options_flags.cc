...
DebugOptions DefaultDebugOptionsIgnoringFlags() {
  ...
  opts.set_xla_gpu_autotune_cache_mode(
...
void MakeDebugOptionsFlags(std::vector<tsl::Flag>* flag_list,
  ...
  // Custom "sub-parser" for xla_gpu_autotune_cache_mode.
  auto setter_for_xla_gpu_autotune_cache_mode = [debug_options](
                                                    const std::string& value) {
    DebugOptions::AutotuneCacheMode autotune_cache_mode;
    if (!DebugOptions::AutotuneCacheMode_Parse(value, &autotune_cache_mode)) {
      return false;
    }
    debug_options->set_xla_gpu_autotune_cache_mode(autotune_cache_mode);
    return true;
  };
  ...
  flag_list->push_back(tsl::Flag(
      "xla_gpu_autotune_cache_mode", setter_for_xla_gpu_autotune_cache_mode,
      DebugOptions::AutotuneCacheMode_Name(
          debug_options->xla_gpu_autotune_cache_mode()),
